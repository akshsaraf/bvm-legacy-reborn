...
const TrophyShowcase = () => {
  ...
  return <section className="section-padding bg-gradient-to-br from-yellow-50 via-amber-50 to-orange-50">
      <div className="container-width">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
          {achievements.map((achievement, index) => <GlassyPanel key={index} className="group hover:scale-105 transition-all duration-300 hover:shadow-2xl">
          ...
          <GlassyPanel className="bg-gradient-to-r from-bvm-navy to-bvm-heritage text-white">
            <div className="p-8 text-center">
              ...
              <div className="mt-6 flex justify-center space-x-8">
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-bvm-gold">
                </div>
